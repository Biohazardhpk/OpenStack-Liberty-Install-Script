...
echo Hello, Please insert the Controller data traffic IP address!
read vardataIPcon
sed -i "s/10.0.1.11/$vardataIPcon/g" 2Controller.sh
echo Your data traffic interface IP  address was set to $vardataIPcon
echo Hello, Please insert the Compute data traffic IP address!
read vardataIPcom
sed -i "s/10.0.0.11/$vardataIPcom/g" 2Compute.sh
echo Your data traffic interface IP  address was set to $vardataIPcom
...
read varADMIN_PASS	
sed -i "s/ADMIN_PASS/$varADMIN_PASS/g" 2Controller.sh
...
read varDEMO_PASS	
sed -i "s/DEMO_PASS/$varDEMO_PASS/g" 2Controller.sh
...
read varRABBIT_PASS	
sed -i "s/RABBIT_PASS/$varRABBIT_PASS/g" 2Controller.sh
sed -i "s/RABBIT_PASS/$varRABBIT_PASS/g" 2Compute.sh
...
sed -i "s/KEYSTONE_DBPASS/$varKEYSTONE_DBPASS/g" 2Controller.sh
...
sed -i "s/GLANCE_DBPASS/$varGLANCE_DBPASS/g" 2Controller.sh
...
read varGLANCE_PASS	
sed -i "s/GLANCE_PASS/$varGLANCE_PASS/g" 2Controller.sh
...
read varNOVA_DBPASS	
sed -i "s/NOVA_DBPASS/$varNOVA_DBPASS/g" 2Controller.sh
...
read varNOVA_PASS	
sed -i "s/NOVA_PASS/$varNOVA_PASS/g" 2Controller.sh
sed -i "s/NOVA_PASS/$varNOVA_PASS/g" 2Compute.sh
...
sed -i "s/NEUTRON_DBPASS/$varNEUTRON_DBPASS/g" 2Controller.sh
...
sed -i "s/NEUTRON_PASS/$varNEUTRON_PASS/g" 2Controller.sh
sed -i "s/NEUTRON_PASS/$varNEUTRON_PASS/g" 2Compute.sh
...
sed -i "s/CEILOMETER_DBPASS/$varCEILOMETER_DBPASS/g" 2Controller.sh	
...
sed -i "s/CEILOMETER_PASS/$varCEILOMETER_PASS/g" 2Controller.sh
...
sed -i "s/CINDER_DBPASS/$varCINDER_DBPASS/g" 2Controller.sh
...
read varCINDER_PASS	
sed -i "s/CINDER_PASS/$varCINDER_PASS/g" 2Controller.sh
...
read varDASH_DBPASS	
sed -i "s/DASH_DBPASS/$varDASH_DBPASS/g" 2Controller.sh
...
read varHEAT_DBPASS	
sed -i "s/HEAT_DBPASS/$varHEAT_DBPASS/g" 2Controller.sh
...
sed -i "s/HEAT_DOMAIN_PASS/$varHEAT_DOMAIN_PASS/g" 2Controller.sh
...
read varHEAT_PASS	
sed -i "s/HEAT_PASS/$varHEAT_PASS/g" 2Controller.sh
...
read varSWIFT_PASS 
sed -i "s/SWIFT_PASS/$varSWIFT_PASS/g" 2Controller.sh
